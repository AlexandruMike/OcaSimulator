 ...
 */
@WebServlet("/creazionedomande")
public class CreazioneDomandeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CreazioneDomandeServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("/WEB-INF/jsp/creazionedomande.jsp").forward(request, response);
	}
